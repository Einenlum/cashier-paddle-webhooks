...
[![Total Downloads](https://img.shields.io/packagist/dt/einenlum/cashier-paddle-webhooks.svg?style=flat-square)](https://packagist.org/packages/einenlum/cashier-paddle-webhooks)

This is where your description should go. Limit it to a paragraph or two. Consider adding a small example.

## Support us

[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/cashier-paddle-webhooks.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/cashier-paddle-webhooks)
...
```bash
php artisan vendor:publish --tag="cashier-paddle-webhooks-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="cashier-paddle-webhooks-views"
```

## Usage

```php
$cashierPaddleWebhooks = new Einenlum\CashierPaddleWebhooks();
echo $cashierPaddleWebhooks->echoPhrase('Hello, Einenlum!');
```
